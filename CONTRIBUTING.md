...
By participating and contributing to this project, you agree to uphold the [Terminal for MkDocs Code of Conduct](hhttps://github.com/ntno/mkdocs-terminal/blob/main/CODE_OF_CONDUCT.md).
