...
class TestThemeStructure:
    ...
    def test_no_duplicate_ids(self, built_example_site):
...
class TestHTMLValidity:
    ...
    def test_index_page_is_valid_html(self, built_example_site):
    ...
    def test_all_generated_pages_have_valid_structure(self, built_example_site):
